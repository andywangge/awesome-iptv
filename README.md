...
- [Jellyfin Desktop](https://github.com/jellyfin/jellyfin-desktop/releases) - Free and open-source media server with built-in Live TV and IPTV support (M3U playlists and XMLTV EPG).
